            ...
            <div class="container">
                ...
                <div id="main-contain">
                    ...
                    <div class="form">
                        ...
                        <form method="post" enctype="multipart/form-data" action="add_teacher.php">
                            <table>
                                ...
                                <tr>
                                    <td>Mã giáo viên</td>
                                    <?php if (!$teacherId) : ?>
                                        <td><input type="text" name="teacher_code" required></td>
                                    <?php else : ?>
                            ...
                            if (empty($_POST['name']) || empty($_POST['teacher_code']) || empty($_POST['phone_number']) || empty($_POST['email'])) {
                                ...
                                if (!$teacherId) {
                                    ...
                                    if ($password == $passwordConfirm) {
                                        $numteacher = count(getAllTeachers());
                                        addUser($username, $password, 1);
                                        addTeacher($teacherCode, $name, $email, $specialize, $gender, $phone, $address, $image);
                                        if ($numteacher == count(getAllTeachers())) {
                                            echo '<p style="color:red;font-weight:bold; ">ERROR: Mã giáo viên đã tồn tại!</p> ';
                                        }
                                        else
                                ...
                                {
                                    editTeacher($teacherId, $teacherCode, $name, $email, $specialize, $gender, $phone, $address, $image);
                                    header('location:../teacher.php');
                                }    
                            }
                        }
                        ?>
                        <br>
                        Chọn menu bên trái hoặc click vào <a href="../teacher.php" style="color: blue; text-decoration:underline; font-weight:bold;">đây</a>
